...
public class AlarmResponse {
  ...
  public AlarmResponse operation(@javax.annotation.Nullable OperationEnum operation) {
  ...
  public AlarmResponse clusterId(@javax.annotation.Nullable Integer clusterId) {
  ...
  public AlarmResponse alarmId(@javax.annotation.Nullable Integer alarmId) {
  ...
  public AlarmResponse className(@javax.annotation.Nullable ClassNameEnum className) {
  ...
  public AlarmResponse ignore(@javax.annotation.Nullable Boolean ignore) {
    this.ignore = ignore;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.operation, alarmResponse.operation) &&
        Objects.equals(this.clusterId, alarmResponse.clusterId) &&
        Objects.equals(this.alarmId, alarmResponse.alarmId) &&
        Objects.equals(this.className, alarmResponse.className) &&
        Objects.equals(this.ignore, alarmResponse.ignore);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AlarmResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AlarmResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AlarmResponse is not found in the empty JSON string", AlarmResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AlarmResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AlarmResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
