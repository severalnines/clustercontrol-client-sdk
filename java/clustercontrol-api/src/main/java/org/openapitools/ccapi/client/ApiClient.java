...
import org.openapitools.ccapi.client.auth.Authentication;
import org.openapitools.ccapi.client.auth.HttpBasicAuth;
import org.openapitools.ccapi.client.auth.HttpBearerAuth;
import org.openapitools.ccapi.client.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    protected String basePath = "https://cchost:9501/v2";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://cchost:9501/v2",
    ...
    protected void init() {
        ...
        setUserAgent("OpenAPI-Generator/OpenAPI specification v1.0.0/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://cchost:9501/v2)
     ...
     * @return a {@link org.openapitools.ccapi.client.ApiClient} object
     */
    ...
    */
     ...
     * @throws org.openapitools.ccapi.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws org.openapitools.ccapi.client.ApiException If fail to serialize the given object
     */
     ...
     * @throws org.openapitools.ccapi.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws org.openapitools.ccapi.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws org.openapitools.ccapi.client.ApiException If the response has an unsuccessful status code or
     ...
     * @param uri URI
     * @throws org.openapitools.ccapi.client.ApiException If fails to update the parameters
     */
     ...
     * @throws org.openapitools.ccapi.client.ApiException If fail to serialize the request body object into a string
     */
     ...
     */
    private void extractAndStoreCmonCookie(Response response) {
        // System.out.println("-----------------------------");
        List<String> values = response.headers().toMultimap().get("set-cookie");
        if (values != null && values.size() > 0) {
            for(int i=0; i<values.size(); i++) {
                String cmonSid = values.get(i);
                if (cmonSid.startsWith("cmon-sid")) {
                    String[] cookieParts = cmonSid.split(";");
                    if (cookieParts.length > 0) {
                        String[] sidParts = cookieParts[0].split("=");
                        if (sidParts.length > 1) {
                            // System.out.println("partA: " + sidParts[0] + ", partB: " + sidParts[1]);
                            mCmonSid = new HashMap<>();
                            mCmonSid.put(new String(sidParts[0]), new String(sidParts[1]));
                        }
                    }
                    break;
                }
