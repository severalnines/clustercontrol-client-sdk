...
class JobsJobJobSpecJobDataConfigServers(BaseModel):
    ...
    members: Optional[List[JobsJobJobSpecJobDataConfigServersMembersInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rs": obj.get("rs"),
            "members": [JobsJobJobSpecJobDataConfigServersMembersInner.from_dict(_item) for _item in obj["members"]] if obj.get("members") is not None else None
        })
        return _obj
