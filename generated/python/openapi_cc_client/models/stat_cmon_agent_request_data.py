...
class StatCmonAgentRequestData(BaseModel):
    ...
    """ # noqa: E501
    begin: Optional[StrictStr] = Field(default=None, description="e.g. \"2021-06-07T09:41:43.636Z\"")
    class_name: Optional[StrictStr] = Field(default=None, alias="className")
    end: Optional[StrictStr] = Field(default=None, description="e.g. \"2021-06-07T09:41:43.636Z\"")
    ...
    __properties: ClassVar[List[str]] = ["begin", "className", "end", "limit", "mimeType", "objectName", "origin"]
    ...
    def class_name_validate_enum(cls, value):
        ...
        if value not in set(['CmnReadParam']):
