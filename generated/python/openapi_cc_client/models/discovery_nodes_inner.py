...
class DiscoveryNodesInner(BaseModel):
    ...
    host_name: Optional[StrictStr] = Field(default=None, description="IP address or Hostname")
    port: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["class_name", "host_name", "port"]
    ...
    def class_name_validate_enum(cls, value):
        ...
        if value not in set(['CmonHost', 'CmonMySqlHost', 'CmonPostgreSqlHost', 'CmonProxySqlHost', 'CmonHaProxyHost']):
