...
class DiscoveryJobJobSpecJobData(BaseModel):
    ...
    nodes: Optional[List[DiscoveryJobJobSpecJobDataNodesInner]] = None
    __properties: ClassVar[List[str]] = ["cluster_type", "mysql_version", "vendor", "nodes"]
    ...
    def cluster_type_validate_enum(cls, value):
        ...
        if value not in set(['group_replication']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "nodes": [DiscoveryJobJobSpecJobDataNodesInner.from_dict(_item) for _item in obj["nodes"]] if obj.get("nodes") is not None else None
        })
        return _obj
