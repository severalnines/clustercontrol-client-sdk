...
class JobsJobJobSpecJobDataNodeConfigurationInner(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """JobsJobJobSpecJobDataNodeConfigurationInner - a model defined in OpenAPI
