...
config_ldap_configuration_group_mappings_inner_from_dict = ConfigLdapConfigurationGroupMappingsInner.from_dict(config_ldap_configuration_group_mappings_inner_dict)
```
