...
from openapi_cc_client.models.config import Config  # noqa: E501
...
class TestConfig(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = openapi_cc_client.models.config.Config()  # noqa: E501
        if include_optional :
            return Config(
                operation = 'getConfig', 
                hostname = '', 
                port = 56, 
                configuration = [
                    openapi_cc_client.models.config_configuration_inner.Config_configuration_inner(
                        name = '', 
                        value = '', 
                        group = '', )
                    ], 
                ldap_configuration = openapi_cc_client.models.config_ldap_configuration.Config_ldap_configuration(
                    enabled = True, 
                    ldap_admin_password = '', 
                    ldap_admin_user = '', 
