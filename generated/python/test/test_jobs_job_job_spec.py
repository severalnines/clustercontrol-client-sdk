...
from openapi_cc_client.models.jobs_job_job_spec import JobsJobJobSpec  # noqa: E501
...
class TestJobsJobJobSpec(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> JobsJobJobSpec:
        """Test JobsJobJobSpec
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JobsJobJobSpec`
        """
        model = JobsJobJobSpec()  # noqa: E501
        if include_optional:
            return JobsJobJobSpec(
