...
public class AlarmResponse {
  ...
  public AlarmResponse operation(OperationEnum operation) {
  ...
  **/
  ...
  public AlarmResponse clusterId(Integer clusterId) {
  ...
  **/
  ...
  public AlarmResponse alarmId(Integer alarmId) {
  ...
  **/
  ...
  public AlarmResponse className(ClassNameEnum className) {
  ...
  **/
  ...
  public AlarmResponse ignore(Boolean ignore) {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AlarmResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
