...
public class JobsJobJobSpecJobDataNodeAdressesInner {
  ...
  public JobsJobJobSpecJobDataNodeAdressesInner hostname(@javax.annotation.Nullable String hostname) {
  ...
  public JobsJobJobSpecJobDataNodeAdressesInner maxConnection(@javax.annotation.Nullable Integer maxConnection) {
  ...
  public void setMaxConnection(@javax.annotation.Nullable Integer maxConnection) {
    this.maxConnection = maxConnection;
  }


  public JobsJobJobSpecJobDataNodeAdressesInner maxReplicationLag(@javax.annotation.Nullable Integer maxReplicationLag) {
  ...
  public void setMaxReplicationLag(@javax.annotation.Nullable Integer maxReplicationLag) {
    this.maxReplicationLag = maxReplicationLag;
  }


  public JobsJobJobSpecJobDataNodeAdressesInner port(@javax.annotation.Nullable Integer port) {
    this.port = port;
    return this;
  }
  ...
  public JobsJobJobSpecJobDataNodeAdressesInner weight(@javax.annotation.Nullable Integer weight) {
    this.weight = weight;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("hostname", "max_connection", "max_replication_lag", "port", "weight"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to JobsJobJobSpecJobDataNodeAdressesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JobsJobJobSpecJobDataNodeAdressesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in JobsJobJobSpecJobDataNodeAdressesInner is not found in the empty JSON string", JobsJobJobSpecJobDataNodeAdressesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!JobsJobJobSpecJobDataNodeAdressesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `JobsJobJobSpecJobDataNodeAdressesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
