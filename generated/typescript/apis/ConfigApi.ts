...
export class ConfigApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async configPost(config: Config, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'config' is not null or undefined
        if (config === null || config === undefined) {
            throw new RequiredError("ConfigApi", "configPost", "config");
        }
...
export class ConfigApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to configPost
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async configPost(response: ResponseContext): Promise<void > {
