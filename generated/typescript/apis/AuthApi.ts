...
export class AuthApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async authPost(authenticate: Authenticate, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'authenticate' is not null or undefined
        if (authenticate === null || authenticate === undefined) {
            throw new RequiredError("AuthApi", "authPost", "authenticate");
        }
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(authenticate, "Authenticate", ""),
            contentType
        );
...
export class AuthApiResponseProcessor {
     ...
     */
     public async authPost(response: ResponseContext): Promise<void > {
