...
// checks if the UsersGroup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UsersGroup{}
...
func (o UsersGroup) ToMap() (map[string]interface{}, error) {
