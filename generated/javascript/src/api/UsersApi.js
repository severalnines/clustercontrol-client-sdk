...
export default class UsersApi {
    ...
    */
    ...
    /**
     * CreateUser | etc
     * @param {module:model/Users} users Manipulate Cmon Users, users that are maintained by the Cmon controller
     * @param {module:api/UsersApi~usersPostCallback} callback The callback function, accepting three arguments: error, data, response
     */
    usersPost(users, callback) {
      let postBody = users;
      // verify the required parameter 'users' is set
      if (users === undefined || users === null) {
        throw new Error("Missing the required parameter 'users' when calling usersPost");
      }
