...
import DiscoveryNodesInner from './DiscoveryNodesInner';
...
class Discovery {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('nodes')) {
                obj['nodes'] = ApiClient.convertToType(data['nodes'], [DiscoveryNodesInner]);
            }
    ...
    static validateJSON(data) {
        ...
        for (const property of Discovery.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['new_cluster_name'] && !(typeof data['new_cluster_name'] === 'string' || data['new_cluster_name'] instanceof String)) {
            throw new Error("Expected the field `new_cluster_name` to be a primitive type in the JSON string but got " + data['new_cluster_name']);
        }
        if (data['nodes']) { // data not null
            ...
            for (const item of data['nodes']) {
                DiscoveryNodesInner.validateJSON(item);
            };
        }
        // validate the optional field `job`
        if (data['job']) { // data not null
          DiscoveryJob.validateJSON(data['job']);
        }
        // validate the optional field `ssh_credentials`
        if (data['ssh_credentials']) { // data not null
          DiscoverySshCredentials.validateJSON(data['ssh_credentials']);
        }
...
Discovery.RequiredProperties = ["operation"];
...
/**
 * @member {Array.<module:model/DiscoveryNodesInner>} nodes
 */
