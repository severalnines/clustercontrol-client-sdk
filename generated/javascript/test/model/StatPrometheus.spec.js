...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveralninesClusterControlRestApiV2.StatPrometheus();
  });
  ...
  describe('StatPrometheus', function() {
    it('should create an instance of StatPrometheus', function() {
      // uncomment below and update the code to test StatPrometheus
      //var instance = new SeveralninesClusterControlRestApiV2.StatPrometheus();
      //expect(instance).to.be.a(SeveralninesClusterControlRestApiV2.StatPrometheus);
    });
    ...
    it('should have the property returnfrom (base name: "returnfrom")', function() {
      // uncomment below and update the code to test the property returnfrom
      //var instance = new SeveralninesClusterControlRestApiV2.StatPrometheus();
      //expect(instance).to.be();
    });
