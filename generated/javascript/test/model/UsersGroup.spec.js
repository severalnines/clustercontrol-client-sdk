...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveralninesClusterControl.UsersGroup();
  });
  ...
  describe('UsersGroup', function() {
    it('should create an instance of UsersGroup', function() {
      ...
      //var instance = new SeveralninesClusterControl.UsersGroup();
      //expect(instance).to.be.a(SeveralninesClusterControl.UsersGroup);
    });
