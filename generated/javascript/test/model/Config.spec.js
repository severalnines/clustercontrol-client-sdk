...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveralninesClusterControlRestApiV2.Config();
  });
  ...
  describe('Config', function() {
    it('should create an instance of Config', function() {
      ...
      //var instance = new SeveralninesClusterControlRestApiV2.Config();
      //expect(instance).to.be.a(SeveralninesClusterControlRestApiV2.Config);
    });
