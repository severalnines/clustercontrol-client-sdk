...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveralninesClusterControl.JobsJob();
  });
  ...
  describe('JobsJob', function() {
    it('should create an instance of JobsJob', function() {
      ...
      //var instance = new SeveralninesClusterControl.JobsJob();
      //expect(instance).to.be.a(SeveralninesClusterControl.JobsJob);
    });
