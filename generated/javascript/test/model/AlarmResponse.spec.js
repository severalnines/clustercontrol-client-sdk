...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveralninesClusterControl.AlarmResponse();
  });
  ...
  describe('AlarmResponse', function() {
    it('should create an instance of AlarmResponse', function() {
      ...
      //var instance = new SeveralninesClusterControl.AlarmResponse();
      //expect(instance).to.be.a(SeveralninesClusterControl.AlarmResponse);
    });
