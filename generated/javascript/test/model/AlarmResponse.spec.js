...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveralninesClusterControlRestApiV2.AlarmResponse();
  });
  ...
  describe('AlarmResponse', function() {
    it('should create an instance of AlarmResponse', function() {
      // uncomment below and update the code to test AlarmResponse
      //var instance = new SeveralninesClusterControlRestApiV2.AlarmResponse();
      //expect(instance).to.be.a(SeveralninesClusterControlRestApiV2.AlarmResponse);
    });
