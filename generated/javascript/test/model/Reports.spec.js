...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveralninesClusterControl.Reports();
  });
  ...
  describe('Reports', function() {
    it('should create an instance of Reports', function() {
      ...
      //var instance = new SeveralninesClusterControl.Reports();
      //expect(instance).to.be.a(SeveralninesClusterControl.Reports);
    });
