...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveralninesClusterControlRestApiV2.Host();
  });
  ...
  describe('Host', function() {
    it('should create an instance of Host', function() {
      ...
      //var instance = new SeveralninesClusterControlRestApiV2.Host();
      //expect(instance).to.be.a(SeveralninesClusterControlRestApiV2.Host);
    });
