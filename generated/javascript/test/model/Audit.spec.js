...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveralninesClusterControl.Audit();
  });
  ...
  describe('Audit', function() {
    it('should create an instance of Audit', function() {
      ...
      //var instance = new SeveralninesClusterControl.Audit();
      //expect(instance).to.be.a(SeveralninesClusterControl.Audit);
    });
