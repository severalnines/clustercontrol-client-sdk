...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveralninesClusterControl.Alarm();
  });
  ...
  describe('Alarm', function() {
    it('should create an instance of Alarm', function() {
      ...
      //var instance = new SeveralninesClusterControl.Alarm();
      //expect(instance).to.be.a(SeveralninesClusterControl.Alarm);
    });
