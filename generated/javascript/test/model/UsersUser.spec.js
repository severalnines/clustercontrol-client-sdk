...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveralninesClusterControl.UsersUser();
  });
  ...
  describe('UsersUser', function() {
    it('should create an instance of UsersUser', function() {
      ...
      //var instance = new SeveralninesClusterControl.UsersUser();
      //expect(instance).to.be.a(SeveralninesClusterControl.UsersUser);
    });
