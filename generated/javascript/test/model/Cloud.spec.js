...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveralninesClusterControl.Cloud();
  });
  ...
  describe('Cloud', function() {
    it('should create an instance of Cloud', function() {
      ...
      //var instance = new SeveralninesClusterControl.Cloud();
      //expect(instance).to.be.a(SeveralninesClusterControl.Cloud);
    });
