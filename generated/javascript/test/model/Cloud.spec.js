...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveralninesClusterControlRestApiV2.Cloud();
  });
  ...
  describe('Cloud', function() {
    it('should create an instance of Cloud', function() {
      ...
      //var instance = new SeveralninesClusterControlRestApiV2.Cloud();
      //expect(instance).to.be.a(SeveralninesClusterControlRestApiV2.Cloud);
    });
