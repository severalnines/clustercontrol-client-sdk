...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveralninesClusterControl.ClustersDatabase();
  });
  ...
  describe('ClustersDatabase', function() {
    it('should create an instance of ClustersDatabase', function() {
      ...
      //var instance = new SeveralninesClusterControl.ClustersDatabase();
      //expect(instance).to.be.a(SeveralninesClusterControl.ClustersDatabase);
    });
