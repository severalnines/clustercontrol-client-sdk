...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveralninesClusterControlRestApiV2.Tree();
  });
  ...
  describe('Tree', function() {
    it('should create an instance of Tree', function() {
      ...
      //var instance = new SeveralninesClusterControlRestApiV2.Tree();
      //expect(instance).to.be.a(SeveralninesClusterControlRestApiV2.Tree);
    });
