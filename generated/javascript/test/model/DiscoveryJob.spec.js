...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveralninesClusterControlRestApiV2.DiscoveryJob();
  });
  ...
  describe('DiscoveryJob', function() {
    it('should create an instance of DiscoveryJob', function() {
      ...
      //var instance = new SeveralninesClusterControlRestApiV2.DiscoveryJob();
      //expect(instance).to.be.a(SeveralninesClusterControlRestApiV2.DiscoveryJob);
    });
