...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveralninesClusterControlRestApiV2.JobsJobJobSpecJobDataReplicaSetsInnerMembersInner();
  });
  ...
  describe('JobsJobJobSpecJobDataReplicaSetsInnerMembersInner', function() {
    it('should create an instance of JobsJobJobSpecJobDataReplicaSetsInnerMembersInner', function() {
      // uncomment below and update the code to test JobsJobJobSpecJobDataReplicaSetsInnerMembersInner
      //var instance = new SeveralninesClusterControlRestApiV2.JobsJobJobSpecJobDataReplicaSetsInnerMembersInner();
      //expect(instance).to.be.a(SeveralninesClusterControlRestApiV2.JobsJobJobSpecJobDataReplicaSetsInnerMembersInner);
    });
