...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveralninesClusterControl.ReportsReport();
  });
  ...
  describe('ReportsReport', function() {
    it('should create an instance of ReportsReport', function() {
      ...
      //var instance = new SeveralninesClusterControl.ReportsReport();
      //expect(instance).to.be.a(SeveralninesClusterControl.ReportsReport);
    });
