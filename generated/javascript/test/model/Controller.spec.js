...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveralninesClusterControl.Controller();
  });
  ...
  describe('Controller', function() {
    it('should create an instance of Controller', function() {
      ...
      //var instance = new SeveralninesClusterControl.Controller();
      //expect(instance).to.be.a(SeveralninesClusterControl.Controller);
    });
