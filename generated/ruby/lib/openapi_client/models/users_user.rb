  ...
  class UsersUser
    ...
    def self.openapi_types
      {
        ...
        :'public_keys' => :'Array<UsersUserPublicKeys>',
        :'public_key' => :'Array<UsersUserPublicKeys>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::UsersUser` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::UsersUser`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      class_name_validator = EnumAttributeValidator.new('String', ["CmonUser"])
    ...
    def class_name=(class_name)
      validator = EnumAttributeValidator.new('String', ["CmonUser"])
    ...
    def hash
      [class_name, user_name, email_address, new_password, old_password, groups, public_keys, public_key].hash
    end
