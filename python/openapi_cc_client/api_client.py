...
from openapi_cc_client import rest
from openapi_cc_client.configuration import Configuration
from openapi_cc_client.exceptions import ApiTypeError, ApiValueError, ApiException
from openapi_cc_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __call_api(
        ...
        try:
            ...
            # Prem: ADDED
            # print(json.dumps(response_data.data.decode('utf-8'), indent=1))
        ...
        # Prem: ADDED
        # print(return_data.data.decode('utf-8'))
        ...
        if _return_http_data_only:
            # Prem: CHANGED
            # return (return_data)
            return (return_data.data.decode('utf-8'))
        else:
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AlarmsApi()
        api_instance.alarm_post  # this is an instance of the class Endpoint
        api_instance.alarm_post()  # this invokes api_instance.alarm_post.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.alarm_post.callable or self.callable in this class
