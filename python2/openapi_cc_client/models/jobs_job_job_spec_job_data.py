...
class JobsJobJobSpecJobData(BaseModel):
    ...
    def vendor_validate_enum(cls, value):
        ...
        if value not in set(['default', 'postgresql', 'percona', 'microsoft', 'redis', 'oracle', 'mariadb', 'elasticsearch', '10gen', 'valkey']):
            raise ValueError("must be one of enum values ('default', 'postgresql', 'percona', 'microsoft', 'redis', 'oracle', 'mariadb', 'elasticsearch', '10gen', 'valkey')")
        return value
