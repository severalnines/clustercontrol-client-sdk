...
class StatCmonAgent(BaseModel):
    ...
    request_data: Optional[StatCmonAgentRequestData] = Field(default=None, alias="requestData")
    __properties: ClassVar[List[str]] = ["operation", "apiKey", "className", "requestData"]

    @field_validator('operation')
    def operation_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['/cmonagent']):
    ...
    def class_name_validate_enum(cls, value):
        ...
        if value not in set(['CmnRequest']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "requestData": StatCmonAgentRequestData.from_dict(obj["requestData"]) if obj.get("requestData") is not None else None
        })
        return _obj
